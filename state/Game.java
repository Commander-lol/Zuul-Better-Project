...
public class Game {
    ...
    /**
    * Gets the room with the given identifier
    * @param room The string that identifies the room to retrieve
    * @return The room with the given name, or null of non existant
    */
